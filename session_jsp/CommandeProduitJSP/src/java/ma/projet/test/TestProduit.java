...
public class TestProduit {
    ...
    public static void main(String[] args) {
        ...
        for (LigneCommandeProduit l : ps.findProduitByCommande1(cms.getById(1)))
            System.out.println( l.getQuantite()+" "+l.getProduit().getReference() + "  " + l.getCommande().getId());
//
...
//        ps.create(new Produit("produit2", 300, cs.getById(1)));
//        ps.create(new Produit("produit3", 400, cs.getById(2)));
//        ps.create(new Produit("produit4", 500, cs.getById(3)));
